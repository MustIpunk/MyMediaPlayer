...
public class MediaService extends Service implements MediaPlayerCallback {
    ...
    public final static String ACTION_CREATE = "com.example.saiful.mymediaplayer.mediaservice.create";
    public final static String ACTION_DESTROY = "com.example.saiful.mymediaplayer.mediaservice.destroy";
